...
步骤十：预验收完成后，协商设备进工厂，接电接气接网，协商物料及调试；制订进厂计划；进厂动作包括：搬运，落位，调水平，对中，接线，接电，接气，单机调试，联合调试；
步骤十一：产线/设备进厂，单机调完后可以试着跑样件，如果每个环节都没问题，则可以进行样件制作了；至首样件能下线，即表示产线具备初步样品下线功能；
步骤十二：样品可以下线之后，需要跑一定量的产品，进行小批量的制样；记录跑线过程中的问题，包括PLC逻辑问题，PLC与MES交互问题，线体动作逻辑，单工站动作逻辑，设备参数及程序参数；所有这些制造参数固化之后，逐步加大跑线的样品，提升节拍，提升OEE，提升质量表现；节拍对应产能，OEE代表产线成熟度，与产线整体的设计目标一致；
至此，一条产线从提出设计目标，到产线实现规划目标，产线的整体制作完成；
